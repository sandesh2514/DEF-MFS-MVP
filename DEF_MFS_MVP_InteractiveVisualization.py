...
class IntVisual:
            ...
            [
                ...
                dbc.Nav(
                    [
                        ...
                        #                             href="/", active="exact", className="fa fa-dashboard"), width=15),
                        #         dbc.Col(dbc.DropdownMenu([dbc.DropdownMenuItem("Comparison",
                        #                                                        href="/pages/windrosecomparison",
                        #                                                        active="exact"),
                        #                                   dbc.DropdownMenuItem("Item 2")], nav=True), width=2)],
                        #         className="g-0")
                        #
                        # ),
    ...
    def render_page_content(value, pathname):
        ...
        if value == "Tesla":
                ...
                dbc.Container([
                    dbc.Row([
                        html.Div([
                            ...
                            html.Div([
                                ...
                                html.P('Changes: ' + f"{df_tesla['Open'].iloc[-1] - df_tesla['Open'].iloc[-2]:,.2f} "
                            ...
                            html.Div([
                                ...
                                html.P('Changes: ' + f"{df_tesla['Close'].iloc[-1] - df_tesla['Close'].iloc[-2]:,.2f} "
                            ...
                            html.Div([
                                ...
                                html.P('Changes: ' + f"{df_tesla['High'].iloc[-1] - df_tesla['High'].iloc[-2]:,.2f} "
                            ...
                            html.Div([
                                ...
                                html.P('Changes: ' + f"{df_tesla['Low'].iloc[-1] - df_tesla['Low'].iloc[-2]:,.2f} "
                    ...
                    dbc.Row([
                        html.Div([
                            ...
                            html.Div([
                                html.H6(children=value+' Stocks Price One Month',
                                        style={
                                            'textAlign': 'center',
                                            'color': 'white'}
                                        ),
                    ...
                    dbc.Row([
                        html.Div([
                            ...
                            html.Div([
                                ...
                                html.P('Changes: ' + f"{df_ford['Open'].iloc[-1] - df_ford['Open'].iloc[-2]:,.2f} "
                            ...
                            html.Div([
                                ...
                                html.P('Changes: ' + f"{df_ford['Close'].iloc[-1] - df_ford['Close'].iloc[-2]:,.2f} "
                            ...
                            html.Div([
                                ...
                                html.P('Changes: ' + f"{df_ford['High'].iloc[-1] - df_ford['High'].iloc[-2]:,.2f} "
                            ...
                            html.Div([
                                ...
                                html.P('Changes: ' + f"{df_ford['Low'].iloc[-1] - df_ford['Low'].iloc[-2]:,.2f} "
            ...
            return [html.H4('Comparison',
                        style={'textAlign': 'center'}),

                dbc.Container([
                    dbc.Row([
                        dcc.Dropdown(['TESLA', 'FORD'], 'TESLA', id='demo-dropdown2'),
